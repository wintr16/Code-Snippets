...
export const THEME_DEFINITONS = {
  ...
  "night-owl": {
    ...
    inherit: true,
    rules: [
      { token: "comment", foreground: "6c6f93" }, // Комментарии
      { token: "string", foreground: "addb67" }, // Строки
      { token: "keyword", foreground: "c792ea" }, // Ключевые слова
      { token: "number", foreground: "f78c6c" }, // Числа
      { token: "type", foreground: "ffcb8b" }, // Типы
      { token: "class", foreground: "ffcb8b" }, // Классы
      { token: "function", foreground: "82aaff" }, // Функции
      { token: "variable", foreground: "d6deeb" }, // Переменные
      { token: "operator", foreground: "89ddff" }, // Операторы
    ],
    colors: {
      "editor.background": "#011627", // Фон
      "editor.foreground": "#d6deeb", // Основной текст
      "editorLineNumber.foreground": "#63778c", // Номера строк
      "editor.selectionBackground": "#4f5b76", // Выделение текста
      "editor.lineHighlightBackground": "#002240", // Подсветка текущей строки
      "editorCursor.foreground": "#80a4c2", // Цвет курсора
      "editor.selectionHighlightBackground": "#4f5b7655", // Полупрозрачное выделение
    },
  },
} 
